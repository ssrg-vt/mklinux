...
static int __init _setup_mem_address(char *str)
{
        mem_address = simple_strtoull(str, 0, 16);
        return 0;
}
early_param("mem_address", _setup_mem_address);
...
static int __init _setup_mem_size(char *str)
{
        mem_size = simple_strtoull(str, 0, 16);
        return 0;
}
early_param("mem_size", _setup_mem_size);
...
static int __init _setup_dump_oops(char *str)
{
        dump_oops = simple_strtoull(str, 0, 16);
        return 0;
}
early_param("dump_oops", _setup_dump_oops);
