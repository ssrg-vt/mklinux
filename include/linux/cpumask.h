...
/*mklinux_akshay*/
#define num_global_online_cpus() cpumask_weight(cpu_global_online_mask)
#define num_possible_cpus()	cpumask_weight(cpu_possible_mask)
#define num_present_cpus()	cpumask_weight(cpu_present_mask)
#define num_active_cpus()	cpumask_weight(cpu_active_mask)
#define cpu_online(cpu)		cpumask_test_cpu((cpu), cpu_online_mask)
/*mklinux_akshay*/
#define cpu_global_online(cpu)	cpumask_test_cpu((cpu), cpu_global_online_mask)
...
/*mklinux_akshay*/
#define cpu_global_online(cpu)	((cpu) == 0)
...
/*mklinux_akshay*/
void init_global_cpu_online(const struct cpumask *src);
