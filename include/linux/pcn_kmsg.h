...
enum pcn_kmsg_type {
    ...
    PCN_KMSG_TYPE_PROC_SRV_FAULT_BARRIER_REQUEST,
    PCN_KMSG_TYPE_PROC_SRV_FAULT_BARRIER_RESPONSE,
    PCN_KMSG_TYPE_PROC_SRV_FAULT_BARRIER_COMMIT,
    PCN_KMSG_TYPE_PROC_SRV_FAULT_BARRIER_RELEASE,
