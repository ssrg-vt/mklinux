...
/*Ajith - added for popcorn */
#define VM_FETCH_LOCAL 0x00001000
...
#define VM_FAULT_ERROR	(VM_FAULT_OOM | VM_FAULT_SIGBUS | VM_FAULT_HWPOISON | \
			 VM_FAULT_FALLBACK | VM_FAULT_HWPOISON_LARGE | VM_FAULT_REPLICATION_PROTOCOL)
