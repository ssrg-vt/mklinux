 ...
 * (public interface)
 *
 * Popcorn Linux scheduler server public interface
 *
 * @author Antonio Barbalace, SSRG Virginia Tech 2016
 */

#ifndef INCLUDE_POPCORN_SCHED_SERVER_H_
#define INCLUDE_POPCORN_SCHED_SERVER_H_
...
#endif /* INCLUDE_POPCORN_SCHED_SERVER_H_ */
