...
static int iommu_init_device(struct device *dev)
{
	...
	printk(KERN_ALERT"amd iommu dev initialised\n");
	return 0;
}
...
int __init amd_iommu_init_devices(void)
{
	...
	printk(KERN_ALERT"AMD IOMMU DEV PERFECTLY INITIALIZED \n");
	return 0;
